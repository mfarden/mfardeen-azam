        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-8 bg-white/5 rounded-2xl border border-white/10 overflow-hidden">
          ...
          <div className="lg:col-span-3 p-8 lg:p-12 pl-8 lg:pl-0">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" disabled={isSubmitting} className=" px-6 py-3 bg-white hover:bg-emerald-500 text-black font-bold uppercase text-[10px] tracking-widest border border-white hover:border-emerald-500 transition-all disabled:opacity-70 disabled:cursor-not-allowed">
